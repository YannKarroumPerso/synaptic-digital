...
1. [Page d'accueil `/` (one-pager)](#page-accueil)
2. [Page `/realisations`](#page-realisations)
...
### 1.3 Bandeau stats (4 chiffres)

| Chiffre | Label |
|---|---|
| **3 sem.** | Délai moyen de livraison |
| **100%** | Mis en ligne dans les délais |
| **95+** | Score Lighthouse moyen |
| **48h** | Premier retour sur votre projet |
...
### 1.5 Section "Notre différence" (fond sombre + 3 piliers + bannière délai)
...
**Intro** : Pas une usine à sites avec 50 chefs de projet. Une équipe resserrée où chacun a un rôle clair, et où vous savez à qui parler.
...
**Intro** : Des sites livrés pour des PME comme la vôtre. Pas de captures Photoshopées : des projets en ligne, avec des résultats concrets.

> Sur la home : 3 cards (les 3 cas clients les plus marquants). Chaque card pointe vers `/realisations/[slug]`.

**Card cas client (template)** :
- Image/screenshot du site
- Nom du client + secteur (ex : *Boulangerie Martin · Boulangerie artisanale*)
- 1 ligne de résultat (ex : *+340% de demandes de devis en 2 mois*)
- Lien `Voir le cas →`

**CTA de fin de section** : `Voir toutes les réalisations →` *(pointe vers /realisations)*

### 1.9 Section Témoignages

**Eyebrow** : `Ils en parlent`
**H2** : Ce que disent nos clients

> Placeholder pour 3-4 témoignages courts (verbatim + nom + entreprise + photo si dispo). À remplir par Yann quand il aura les vrais.
...
**Intro** : Le bon prix dépend de votre projet. Voici des ordres de grandeur pour vous repérer.

| Package | Fourchette | Description |
|---|---|---|
| Site vitrine | **3 000 € – 4 500 €** | 4 à 6 pages, design sur-mesure, SEO de base, formulaire de contact, livré en 3 semaines. |
...
#### Q6. Vous faites du référencement après la livraison ?
...
### 1.12 Section Contact (formulaire)

**Eyebrow** : `Démarrer mon projet`
**H2** : Parlons-en concrètement
**Intro** : Premier échange gratuit, sans engagement. On vous répond sous 48h, on cale 30 minutes ensemble pour comprendre votre projet, et si on est d'accord, on vous envoie une proposition détaillée sous 5 jours.

#### Formulaire (4 champs max)
- **Nom** *(obligatoire)*
...
**Texte légal sous le bouton** : *En envoyant ce formulaire, vous acceptez d'être recontacté par email. Vos données ne sont pas partagées avec des tiers. [Voir la politique RGPD]*

#### Bandeau "Que se passe-t-il ensuite ?" sous le formulaire
- ⏱ **Sous 48h** : vous recevez un email de réponse
- 📞 **30 min** : un échange pour cadrer votre projet
- 📋 **Sous 5 jours** : proposition détaillée si on est d'accord pour avancer
...
**Footer bottom**
- © 2026 Synaptic Digital EURL. Tous droits réservés.
- [Mentions légales] · [Données personnelles]

---

<a id="page-realisations"></a>
## 2. Page `/realisations`
...
Cards en grille 3 colonnes desktop, 2 mobile, 1 mobile étroit.

**Format d'une card** :
- Screenshot du site
- Logo client (overlay subtil)
- Nom du client
- Secteur · Type de projet (ex : *Site vitrine + SEO*)
- 1 résultat fort en surimpression (ex : *+340% de demandes de devis*)
- Lien `Voir le cas →`

### CTA en bas de page
**Titre** : Votre projet pourrait être le prochain.
**Bouton** : `Démarrer mon projet →` *(pointe vers /#contact)*

---

<a id="template-cas"></a>
## 3. Template `/realisations/[cas-client]`

Structure type pour chaque cas. Yann remplira chaque section avec les vrais contenus de ses 2 premiers cas.

### Hero du cas
- **Eyebrow** : Cas client · `[Secteur]`
- **H1** : `[Nom client]` *(ex : Boulangerie Martin)*
- **Sous-titre** : `[Une phrase qui résume ce qu'on a fait]` *(ex : Refonte complète + SEO local pour une boulangerie artisanale parisienne.)*
- **Visuel principal** : screenshot ou mockup du site

### Bandeau résultats (3-4 chiffres clés)
- `[Métrique 1]` *(ex : +340% demandes de devis)*
- `[Métrique 2]` *(ex : Score Lighthouse 98)*
- `[Métrique 3]` *(ex : Top 3 Google sur "boulangerie 18e")*
- `[Métrique 4]` *(ex : Livré en 19 jours)*

### Section "Le contexte"
**H2** : Le contexte
*(2-3 paragraphes : qui est le client, son activité, son besoin initial, ce qui le bloquait avec son ancien site.)*

### Section "Ce qu'on a fait"
**H2** : Ce qu'on a fait
*(3-4 paragraphes : approche stratégique, choix design, choix techniques, intégrations particulières, points d'attention.)*

**Sous-cards (3-4)** :
- Stratégie : *(ce qu'on a posé)*
- Design : *(parti pris visuel)*
- Performance : *(résultats techniques)*
- SEO : *(positionnements ciblés et atteints)*

### Section "Les résultats"
**H2** : Les résultats, 6 mois après
*(2 paragraphes : chiffres mesurés, évolution du trafic, retours qualitatifs du client.)*

### Témoignage du client
**Verbatim** : "Citation directe du client, 2-3 lignes maximum."
**Signature** : Prénom Nom, Fonction, Entreprise

### Galerie / captures
3 à 6 captures du site (desktop + mobile) en grille.

### CTA bas de page
**Titre** : Un projet similaire en tête ?
**Bouton** : `Discuter de votre projet →`
**Lien retour** : `← Voir toutes les réalisations`

---

<a id="mentions-legales"></a>
## 4. Page `/mentions-legales`

### Contenu (reprise du site existant + nettoyage)

**H1** : Mentions légales

#### Éditeur du site
- **Dénomination sociale** : Synaptic Digital EURL
- **Forme juridique** : EURL (Entreprise Unipersonnelle à Responsabilité Limitée)
- **Capital social** : `[À compléter]` €
- **Siège social** : 33 rue des Petits Champs, 16400 Vœuil-et-Giget
- **SIRET** : `[À compléter]`
- **Gérant** : Karroum Yann
- **Email** : contact@synaptic-digital.fr
- **Site web** : synaptic-digital.fr
...
Synaptic Digital EURL s'engage à assurer la protection, la confidentialité et la sécurité des données personnelles de ses utilisateurs, conformément au Règlement Général sur la Protection des Données (RGPD) et à la loi Informatique et Libertés. Les données collectées via le site (formulaire de contact, cookies) sont utilisées uniquement dans le cadre de la relation commerciale et ne sont en aucun cas cédées à des tiers.
...
<a id="microcopy"></a>
## 5. Microcopy & messages système

### Boutons CTA récurrents
| Contexte | Texte |
|---|---|
| CTA principal partout | **Démarrer mon projet** |
| CTA secondaire | **Voir nos réalisations** |
| CTA après case study | **Discuter de votre projet** |
| CTA contact direct | **Réserver 30 min** |

### États du formulaire de contact
- **Pendant l'envoi** : `Envoi en cours…`
- **Succès** : `Message envoyé ! On vous répond sous 48h.`
- **Erreur générique** : `Oups, le message n'est pas parti. Vous pouvez réessayer ou nous écrire directement à contact@synaptic-digital.fr.`
- **Validation email** : `L'email saisi semble invalide.`
- **Champ obligatoire vide** : `Ce champ est obligatoire.`

### Bandeau cookies (RGPD)
**Titre** : Cookies
**Texte** : On utilise des cookies techniques pour faire fonctionner le site et, avec votre accord, des cookies analytiques pour mesurer ce qui marche. Pas de publicité, pas de tracking croisé.
**Boutons** : `Tout accepter` · `Personnaliser` · `Refuser les non-essentiels`

### Page 404
**Titre** : Cette page est introuvable
**Texte** : L'URL est peut-être périmée, ou vous avez suivi un lien cassé. Pas de drame.
**Bouton** : `Retour à l'accueil →`

### Page de remerciement après envoi formulaire (`/merci`)
**Titre** : Merci, votre message est bien arrivé.
**Texte** : On a reçu votre demande. Vous recevez un email de réponse sous 48h. En attendant, vous pouvez :
- Découvrir [nos réalisations](/realisations)
- Comprendre [notre approche](/#approche)
...
## 7. Notes pour Yann à compléter / valider

1. **Capital social et SIRET** dans mentions légales : à renseigner
2. **Hébergeur** dans mentions légales : Vercel ou OVH (préférence ?)
3. **Stats du bandeau** (3 sem. / 100% / 95+ / 48h) : valider qu'on peut tenir ces chiffres (sinon ajuster)
4. **Équipe** : envoyer les 4 vrais noms + photos + 1 phrase de bio chacun
5. **Témoignages** : envoyer les 3-4 verbatim clients (avec accord d'utilisation)
6. **2 cas clients** : envoyer les détails (contexte, problématique, solution, résultats chiffrés, témoignage, captures d'écran)
7. **Téléphone** dans footer : on l'affiche ou pas ?
8. **Cookies analytiques** : préférence Vercel Analytics, Plausible, ou Matomo ?
